...
miAmbiente$dataset_competencia <- "~/datasets/utn_competencia_balanceados.csv"


# aqui va su primer semilla
miAmbiente$semilla_primigenia <- 100103L
...
dir.create("~/buckets/b1/repos/dmeyf2024", showWarnings = FALSE)
