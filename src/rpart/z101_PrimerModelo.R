...
modelo <- rpart(
    ...
    xval = 0,
    cp = -0.632039191, # esto significa no limitar la complejidad de los splits
    minsplit = 3006, # minima cantidad de registros para que se haga el split
    minbucket = 1222, # tamaño minimo de una hoja
