...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(
    ...
    202006,# 202006  Excluyo por variables rotas
    202005, 202004, 202003, 202002, 202001,
    201912, 201911,
    201910,# 201910 Excluyo por variables rotas
    201909, 201908, 201907, 201906,
    201905,# 201905  Excluyo por variables rotas
    201904, 201903
  )
...
wf_SEMI_sep_orden227 <- function( pnombrewf )
{
  ...
  CN_canaritos_asesinos_base(ratio=0.3, desvio=1.0)
