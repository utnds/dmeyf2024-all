...
envg$EXPENV$exp_dir <- "~/buckets/b1/expw_4/" # esto modifico, expw por expw_2
...
FEhist_base <- function( pinputexps)
{
  ...
  # si(no) me engraso las manos con las tendencias de segundo orden
...
wf_septiembre <- function( pnombrewf )
{
  ...
  ht <- HT_tuning_base( bo_iteraciones = 100 )  # iteraciones inteligentes(NO SE SI TANTO)
