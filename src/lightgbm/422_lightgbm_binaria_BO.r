...
hs <- makeParamSet(
  #Controla los cambios en cada iteracion. Menor LR menores cambios
  #if you reduce num_iterations, you should increase learning_rate.
  makeNumericParam("learning_rate", lower = 0.01, upper = 0.3),
  
  #Complejidad del arbol. Cantidad de hojas
  makeIntegerParam("num_leaves", lower = 8L, upper = 1024L),
  
  #Proporcion de variables que se usa en cada iteracion
  #Menos variables, mayor diversidad y menos sobreajuste
  #Valores altos, menor diversidad, mas precisicion posible sobreajuste
  makeNumericParam("feature_fraction", lower = 0.2, upper = 0.8),
  
  #Proporcion de datos que se usan
  makeNumericParam("bagging_fraction", lower = 0.1, upper = 0.8),
  
  #cantidad de datos en una hoja final del arbol
  #valores bajos puede generar OF valores altos modelo menos complejos
  makeIntegerParam("min_data_in_leaf", lower = 1L, upper = 8000L),
  
  #envios determina cuántas de las mejores predicciones (con mayor probabilidad 
  #de ser positivas) se utilizan para calcular la ganancia final del modelo
  #
