...
hs <- makeParamSet(
  ...
  makeIntegerParam("min_data_in_leaf", lower = 1L, upper = 3000L),
  makeIntegerParam("num_interaction", lower = 10L, upper = 2000L),
  makeIntegerParam("max_depth", lower = 3L, upper = 12L),
  makeNumericParam("bagging_fraction", lower = 0.5, upper = 1),
  makeIntegerParam("lambda_l1", lower = 0L, upper = 50L),
  makeIntegerParam("lambda_l2", lower = 0L, upper = 50L),
  makeIntegerParam("max_bin", lower = 10L, upper = 100L),
  makeIntegerParam("min_split_grain", lower = 0L, upper = 10L),
