...
hs <- makeParamSet(
  ...
  makeIntegerParam("max_depth", lower = 1L, upper = 15L),        # Ampliado para mayor profundidad
  ...
  makeNumericParam("bagging_fraction", lower = 0.1, upper = 0.9),  # Ajustado para mayor muestreo
  makeIntegerParam("bagging_freq", lower = 1L, upper = 10L),
  makeNumericParam("lambda_l1", lower = 0, upper = 5),            # Ajustado para regularización
  makeIntegerParam("envios", lower = 5000L, upper = 15000L),
  makeNumericParam("lambda_l2", lower = 0, upper = 5)             # Ajustado para regularización
)
