...
PARAM$finalmodel$learning_rate <- 0.037891552
PARAM$finalmodel$feature_fraction <- 0.546083035
PARAM$finalmodel$min_data_in_leaf <-1247
PARAM$finalmodel$num_leaves <- 380
