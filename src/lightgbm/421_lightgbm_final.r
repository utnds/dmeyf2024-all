...
PARAM$finalmodel$num_iterations <- 2000 #1000
PARAM$finalmodel$learning_rate <- 0.015 #0.027
PARAM$finalmodel$feature_fraction <- 0.5 #0.8
PARAM$finalmodel$min_data_in_leaf <- 115 #76
PARAM$finalmodel$num_leaves <- 8 #8
