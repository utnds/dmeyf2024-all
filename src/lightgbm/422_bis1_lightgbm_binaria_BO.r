...
hs <- makeParamSet(
  ...
  makeIntegerParam("min_split_gain", lower = 0L, upper = 15L),
  makeNumericParam("bagging_fraction", lower = 0, upper = 1),
  makeNumericParam("learning_rate", lower = 0.01, upper = 0.3), # valores de acuerdo al articulo de catedra
