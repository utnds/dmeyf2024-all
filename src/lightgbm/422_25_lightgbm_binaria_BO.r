...
hs <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.01, upper = 0.3),  # Ajustado para optimización
  makeNumericParam("min_split_gain", lower = 0, upper = 20),  # Ajustado para optimización
  makeIntegerParam("num_leaves", lower = 31L, upper = 256L),    # Ajustado para mayor flexibilidad
  makeIntegerParam("min_data_in_leaf", lower = 1L, upper = 200L), # Ajustado para manejar datos escasos
  makeNumericParam("feature_fraction", lower = 0.1, upper = 0.9), # Ajustado para mayor selección de características
  makeNumericParam("bagging_fraction", lower = 0.1, upper = 1.0),  # Ajustado para mayor muestreo
  makeIntegerParam("bagging_freq", lower = 1L, upper = 10L),
  makeNumericParam("lambda_l1", lower = 0, upper = 1000),            # Ajustado para regularización
  makeIntegerParam("envios", lower = 5000L, upper = 15000L),
  makeNumericParam("lambda_l2", lower = 0, upper = 1000)             # Ajustado para regularización
)
