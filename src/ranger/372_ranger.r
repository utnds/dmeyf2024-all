...
PARAM$ranger <- list(
  "num.trees" = 466, # cantidad de arboles
  "mtry" = 11, # cantidad de atributos que participan en cada split
               # la cantidad de variables que se tiene son: 154
  "min.node.size" = 598, # tamaño minimo de las hojas
